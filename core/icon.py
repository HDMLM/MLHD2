...
PLANET_PROFILES = {
    ...
    "Pilen V": iconconfig['BiomePlanets']['Scoured - Pilen V'],
	...
	"Widow's Harbor": iconconfig['BiomePlanets']['Scoured - Widow\'s Harbor'],
	...
	"New Haven": iconconfig['BiomePlanets']['Scoured - New Haven'],
	...
	"Merak": iconconfig['BiomePlanets']['Ionic Jungle'],
