...
subfaction_counts_3 = (
    subfaction_counts_2.drop(search_subfaction2) if search_subfaction2 != "None" else subfaction_counts_2
)
difficulty_counts_3 = (
    difficulty_counts_2.drop(search_difficulty2) if search_difficulty2 != "None" else difficulty_counts_2
)
    ...
    "embeds": [
        {
            ...
            "footer": {
                "text": f"{dcord_data['discord_uid']}   v{VERSION}{DEV_RELEASE}",
            ...
            "image": {
                "url": "https://cdn.discordapp.com/attachments/1340508329977446484/1414378556825538601/favouritesbanner.png?ex=68bf5a2d&is=68be08ad&hm=b27d54aca26e82249e873ab14cdd87a698dcc5242b38d563dc7218522197174c&"
            },
